...
SECRET_KEY = 'django-insecure-7hvv9zi+p)+rh*zy$mw&ep*q^h=n$486i)4v%(dflh!qqpja(%'
...
#Customizing djoser to use our serializer instead of the one provided by djoser
DJOSER={
    'SERIALIZERS':{
